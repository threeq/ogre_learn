...
//---------------------------------------------------------------------
void BasicTutorial5::createScene()
{
    ...
    // make it look towards the njija
...
// OIS::KeyListener
bool BasicTutorial5::keyPressed( const OIS::KeyEvent &arg )
{
    switch (arg.key)
    {
    case OIS::KC_1:
...
bool BasicTutorial5::keyReleased( const OIS::KeyEvent &arg )
{
...
// OIS::MouseListener
bool BasicTutorial5::mouseMoved( const OIS::MouseEvent &arg )
{
...
bool BasicTutorial5::mousePressed( const OIS::MouseEvent &arg, OIS::MouseButtonID id )
{
...
bool BasicTutorial5::mouseReleased( const OIS::MouseEvent &arg, OIS::MouseButtonID id )
{
    return true;
}
